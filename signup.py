...
def connect_database():
    if emailEntry.get() == '' or usernameEntry.get() == '' or passwordEntry.get() == '' or \
        ...
        try:
            con = pymysql.connect(host='localhost', user='root', password='Spj@3123')
            mycursor = con.cursor()
        except:
    ...
    try:
        ...
        query = 'use userdata'
        mycursor.execute(query)
        query = 'create table data(id int auto_increment primary key not null, email varchar(50),username varchar(' \
...
signup_window.iconbitmap('myicon.ico')
...
emailEntry = Entry(frame, width=25, font=('Microsoft Yahei UI Light', 18, 'bold'), fg='white', bg='firebrick1')
...
usernameEntry = Entry(frame, width=25, font=('Microsoft Yahei UI Light', 18, 'bold'), fg='white', bg='firebrick1')
...
passwordEntry = Entry(frame, width=25, font=('Microsoft Yahei UI Light', 18, 'bold'), fg='white', bg='firebrick1')
passwordEntry.grid(row=6, column=0, sticky='w', padx=25)

###
confirmpasswordLabel = Label(frame, text='Confirm Password', font=('Microsoft Yahei UI Light', 10, 'bold'), bg='white',
                             fg='firebrick1')
confirmpasswordLabel.grid(row=7, column=0, sticky='w', padx=25, pady=(10, 0))

confirmpasswordEntry = Entry(frame, width=25, font=('Microsoft Yahei UI Light', 18, 'bold'), fg='white',
                             bg='firebrick1')
confirmpasswordEntry.grid(row=8, column=0, sticky='w', padx=25)

###
check = IntVar()
termsandcondition = Checkbutton(frame, text='I agree to the Terms & Conditions',
...
####
signupButton = Button(frame, text='REGISTER', font=('Open Sans`   ', 16, 'bold'), bd=0, bg='firebrick1', fg='white',
